 ...
 *
 * @param {{question: string, timeZone?: string}} input
 * @param {{env?: object, fetchImpl?: Function, timeoutMs?: number}} [deps]
 * @returns {Promise<{title: string, answer: string, detail: string, model: string, elapsedMs: number, usage: object|null}>}
 */
