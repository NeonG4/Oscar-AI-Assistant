 ...
 * lib/tools/tasks.js
 * ----------------------------------------------------------------------------
 * Google Tasks: read the list, add to it, tick things off.
 *
...
export const completeTaskTool = {
  name: 'complete_task',
  description:
    'Mark a Google Task as done. Call list_tasks first to find the task id — never guess one. ' +
    'This only marks tasks complete; it cannot delete them.',
  parameters: {
    type: 'object',
    properties: {
