...
export const finishTaskTool = {
  name: 'finish_task',
  description:
    'Mark one task from your list as done, and say what came of it. Call this the moment a task ' +
    'is actually finished — not in a batch at the end, because the point is that the user can ' +
    'see where you are while you are still working. The note is one line: what you found, what ' +
    'you made, what you decided. If a task turned out to be impossible, still mark it done and ' +
    'say so in the note.',
  parameters: {
    type: 'object',
    properties: {
